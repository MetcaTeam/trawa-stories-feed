    ...
    tart_cherry_juice: [
      {
        ...
        image: "https://i.imgur.com/slOpf9x.png",
        caption: "10 полезных свойств сока из кислой вишни для похудения и здоровья сердца",
        captionColor: "#FFFFFF",
      },
      {
        type: "titleImageTextPost",
        title: "Снижение воспаления",
        image: "https://i.imgur.com/iTzkZWR.png",
        bgColor: "#8B4513",
        text: "Сок из кислой вишни содержит антоцианы, которые помогают уменьшить воспаление в организме, что способствует улучшению здоровья сердца и ускорению метаболизма.",
      },
      {
        type: "titleImageTextPost",
        title: "Антиоксидантная защита",
        image: "https://i.imgur.com/v95vbLP.png",
        bgColor: "#8B4513",
        text: "Высокое содержание антиоксидантов в соке помогает бороться с окислительным стрессом, что положительно влияет на сердечно-сосудистую систему и способствует общему укреплению организма.",
      },
      {
        type: "titleImageTextPost",
        title: "Снижение уровня холестерина",
        image: "https://i.imgur.com/MyIj04I.png",
        bgColor: "#8B4513",
        text: "Регулярное употребление сока из кислой вишни может способствовать снижению уровня плохого холестерина (LDL) и увеличению уровня хорошего холестерина (HDL), что важно для здоровья сердца.",
      },
      {
        type: "titleImageTextPost",
        title: "Улучшение качества сна",
        image: "https://i.imgur.com/LZGJsUd.png",
        bgColor: "#8B4513",
        text: "Мелатонин, содержащийся в соке, помогает регулировать цикл сна, что важно для восстановления организма и поддержания здорового веса.",
      },
      {
        type: "titleImageTextPost",
        title: "Снижение мышечной боли",
        image: "https://i.imgur.com/7ClrY2u.png",
        bgColor: "#8B4513",
        text: "Антиоксиданты и противовоспалительные свойства сока способствуют уменьшению мышечной боли после тренировок, что полезно для людей, активно занимающихся спортом и стремящихся к снижению веса.",
      },
      {
        type: "titleImageTextPost",
        title: "Регуляция артериального давления",
        image: "https://i.imgur.com/J8Ndqgr.png",
        bgColor: "#8B4513",
        text: "Полифенолы, присутствующие в соке из кислой вишни, помогают снижать артериальное давление, что благоприятно влияет на здоровье сердца.",
      },
      {
        type: "titleImageTextPost",
        title: "Поддержание уровня сахара в крови",
        image: "https://i.imgur.com/lX9zQSC.png",
        bgColor: "#8B4513",
        text: "Сок может способствовать стабилизации уровня сахара в крови, что важно для контроля веса и снижения риска сердечно-сосудистых заболеваний.",
      },
      {
        type: "titleImageTextPost",
        ...
        image: "https://i.imgur.com/slOpf9x.png",
        bgColor: "#8B4513",
        text: "Антиоксиданты в соке помогают улучшить кровообращение, что способствует лучшему питанию клеток и снижению риска заболеваний сердца.",
      },
      {
        type: "titleImageTextPost",
        title: "Снижение риска метаболического синдрома",
        image: "https://i.imgur.com/vXAcerw.png",
        bgColor: "#8B4513",
        text: "Регулярное употребление сока может помочь снизить риск развития метаболического синдрома, который включает в себя высокое артериальное давление, повышенный уровень сахара в крови и ожирение.",
      },
      {
        type: "titleImageTextPost",
        title: "Укрепление иммунной системы",
        image: "https://i.imgur.com/KBtd46q.png",
        bgColor: "#8B4513",
        text: "Витамины и минералы, содержащиеся в соке из кислой вишни, помогают укрепить иммунную систему, что важно для общего здоровья и предотвращения различных заболеваний, включая сердечно-сосудистые.",
      },
    ],
    procrastination: [
      {
